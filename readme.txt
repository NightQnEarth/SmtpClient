	...
	Необходим интерпретатор Python версии не ниже, чем 3.6.
       		                      ...
       		                      Описание:
                        —————————————————————————————————
	MailSender - программа для рассылки электронной почты.
...
--mail-to [-m]				- Обязательным именнованным аргументом принимается строка, содержащая почтовые адреса получаетелей
	...
	python main.py sender.first@yandex.ru -s smtp.yandex.ru -m receiver.first@yandex.ru
	Далее, пользователю будет предложено ввести пароль для почтового ящика отправителя. Если логин или пароль отправителя были 
	введены неверно, пользователю будет дано 3 попытки на повторную аутентификацию.
...
Код выхода "2"  - выход произведён в связи с неверным форматом ввода адреса получателя.
                  Пример верного формата ввода строки с адресом: receiver.first@yandex.ru
...
Код выхода "8"  - выход произведён в связи с использованием интерпретатора
                  версии ниже, чем 3.6
.
								...
								Установка программы
					—————————————————————————————————
	Сохраните папку со сборкой в произвольном каталоге. Дополнительных инструментов, помимо интерпретатора
	Python 3.6, не требуется.
		
		
		
									Создатели
					—————————————————————————————————
	Russia, Ural Federal University, Chernuschenko Denis Yurievich.
	...
	Web site : https://vk.com/id191434305
